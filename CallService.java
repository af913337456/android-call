...
//            Toast.makeText(this, "Incoming call from " + call.getDetails().getHandle().getSchemeSpecificPart(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "拨打: " + call.getDetails().getHandle().getSchemeSpecificPart(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onCallRemoved(Call call) {
        ...
        if (CallListHelper.callList.size() > 0){
            ...
            Log.d(MainActivity.TAG, "onCallRemoved---> " + call.getDetails().getHandle().getSchemeSpecificPart());
        }
    }
}
